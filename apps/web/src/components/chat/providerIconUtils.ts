 ...
 */
const BRAND_ICON_MATCHERS: ReadonlyArray<{ pattern: RegExp; icon: Icon | null }> = [
  ...
  { pattern: /\b(?:claude|anthropic|opus|sonnet|haiku|fable)\b/iu, icon: ClaudeAI },
  ...
  { pattern: /\b(?:deepseek|qwen|glm|zhipu|minimax|mistral|llama)\b/iu, icon: null },
];
