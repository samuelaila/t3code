...
// Sidebar sort: most recent activity on top (user message / turn / updatedAt
// / createdAt). Applies for All projects and when a single project is
// filtered — both pass through the same activeThreads partition.
// NOTE: intentionally diverges from upstream, which sorts by static creation
// order and never reorders on activity.
