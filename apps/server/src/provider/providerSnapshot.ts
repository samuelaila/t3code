...
export function providerModelsFromSettings(
  ...
  // A resolver is accepted as well as a flat set: Claude custom models take
  // their reasoning menu from the slug (Grok slugs have no "max" effort).
    ...
    customEntries.push({
      ...
      capabilities:
        ...
        (typeof customModelCapabilities === "function"
          ? customModelCapabilities(entry.slug)
